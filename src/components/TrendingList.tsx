...
export default function TrendingList() {
    ...
    }, [type, timeWindow, i18n.language, isValidType]);
    ...
    const getTitle = () => {
        switch (type) {
            ...
            case 'person': return t('common.people', 'People');
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <button
                            ...
                            style={{
                                backgroundColor: timeWindow === 'day' ? '#fff' : 'transparent',
                                color: timeWindow === 'day' ? '#000' : '#ccc',
                                border: 'none',
                                padding: '8px 24px',
                                borderRadius: '20px',
                                cursor: 'pointer',
                        ...
                        <button
                            ...
                            style={{
                                backgroundColor: timeWindow === 'week' ? '#fff' : 'transparent',
                                color: timeWindow === 'week' ? '#000' : '#ccc',
                                border: 'none',
                                padding: '8px 24px',
                                borderRadius: '20px',
                                cursor: 'pointer',
